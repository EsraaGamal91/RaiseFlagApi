...
namespace RaiseFlag.DAL.Models
{
    ...
    public partial class RaiseFlagEntities : DbContext
    {
        public RaiseFlagEntities()
            : base("name=RaiseFlagEntities")
        {
        }
        ...
        public virtual DbSet<OutOfRegionLog> OutOfRegionLogs { get; set; }
